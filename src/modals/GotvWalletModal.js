...
const GotvWalletModal = ({ gotvWalletAccessOpen, closeGotvWalletAccess }) => {
  ...
  const [fieldError, setFieldError] = useState({
    ...
    IUC_Number: { message: "", error: false },
  });
  ...
  return (
    <div>
      <Modal
        isOpen={gotvWalletAccessOpen}
        onRequestClose={() => closeGotvWalletAccess()}
...
export default GotvWalletModal;
